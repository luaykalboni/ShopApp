...
namespace ShopApp.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(shoppingsiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,imagePath,IsinStock,CategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,imagePath,IsinStock,CategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
